defmodule Input do
 ...
 attr :id, :any, default: nil
  ...
  @no_error_classes "border-teal-500 focus:border-teal-500 focus:ring-teal-500"
  ...
  def input(%{variant: "default"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <div class="relative">
        <input
          ...
          class={[
            ...
            phx-no-feedback:dark:focus:ring-neutral-600 phx-no-feedback:dark:border-neutral-700
            phx-no-feedback:border-gray-200 phx-no-feedback:focus:border-blue-500
            phx-no-feedback:focus:ring-blue-500 #{@class}",
            @errors == [] &&
              @no_error_classes,
            @errors != [] &&
              @error_classes
      ...
      <%= if @errors == [] do %>
        ...
        <p class="text-sm text-teal-600 mt-2 phx-no-feedback:hidden" id="hs-validation-name-success-helper">Looks good!</p>
        <% end %>
    </div>
    """
  end
  ...
  def input(%{variant: "gray"} = assigns) do
    ...
    <div class="flex justify-between">
      ...
      <div class="relative">
        <input
          ...
          class={[
            ...
            w-full block px-4 py-3 text-sm rounded-lg phx-no-feedback:bg-gray-100
            dark:bg-neutral-700 dark:text-neutral-400 #{@class}",
            @icon && "ps-11", @errors == [] && "bg-teal-100/50", @errors != [] && "bg-red-100/50"
          ]}
          {@rest}
        />
        <div
      ...
      <p :if={Phoenix.Component.used_input?(@name) && @helper} class="mt-2 text-sm text-gray-500 dark:text-neutral-500" id="input-helper-text"> <%= @helper %> </p>
      <.error :for={msg <- @errors}>
        <%= msg %>
      </.error>

      <%= if @errors == [] do %>
          <p class="text-sm text-teal-600 mt-2 phx-no-feedback:hidden"
  ...
  #             placeholder={@placeholder}
  #             class={[
  #               "w-full block py-3 text-sm bg-transparent border-b-2 peer pe-0 ps-8 border-t-transparent
  #               border-x-transparent
  #               phx-no-feedback:border-b-gray-200
  #               focus:border-t-transparent focus:border-x-transparent
  #               phx-no-feedback:focus:border-b-blue-500 focus:ring-0 focus:border-b-transperant focus:outline-none
  #               dark:border-b-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
  #               dark:focus:border-b-gray-600 #{@class}",
  #               @errors == [] &&
